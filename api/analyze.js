      ...
      input: [
        {
          role: "system",
          content: `
Sei OperaAI, un assistente intelligente per il back-office delle piccole aziende.
...
`
    ...
    if (!text) {
      throw new Error("Il modello non ha restituito alcun risultato.");
    }
    ...
    console.error("OperaAI API error:", error);
